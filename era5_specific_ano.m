...
function [era5_ws_ano, era5_wd_ano, era5_wd_ano_org] =  era5_specific_ano(year_file, epoch_anom, pre_lev, lat_ano, lon_ano)

era5_myFolder = 'D:\ERA5';     
era5_file_name = ['ind_',year_file,'_7_9_900_1000.nc'];

era5_file = fullfile(era5_myFolder, era5_file_name);
...
[~, era5_lat_near_ano] = (min(abs(lat_ano-era5_lat))); 
[~, era5_lon_near_ano] = (min(abs(lon_ano-era5_lon)));
